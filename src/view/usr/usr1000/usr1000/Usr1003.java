...
public class Usr1003 implements JavaHTML {
	...
	public void response(Request request) throws Exception {
		...
		//회원 정보가 있는 경우
			...
			//회원명
			do {
				System.out.println("* 이름을 작성하세요. [회원 수정을 멈추고 나가고 싶으면 n 작성]");
			...
			//성별 선택
			do {
				System.out.println("* 성별을 작성하세요. [회원 수정을 멈추고 나가고 싶으면 n 작성]");
			...
			//연락처 작성
			do {
				System.out.println("* 연락처를 작성하세요. [010-xxxx-xxxx 형식으로 작성] [회원 수정을 멈추고 나가고 싶으면 n 작성]");
			...
			//주소 작성
			System.out.println("주소를 작성하세요. [주소는 필수 값이 아닙니다.] [회원 수정을 멈추고 나가고 싶으면 n 작성]");
			...
			//회원 설명
			System.out.println("회원 설명을 작성하세요. [회원 설명은 필수 값이 아닙니다.] [회원 수정을 멈추고 나가고 싶으면 n 작성]");
